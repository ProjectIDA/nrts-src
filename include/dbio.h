#pragma ident "$Id: dbio.h,v 1.4 2016/07/20 22:55:59 dechavez Exp $"
/*======================================================================
 *
...
#ifdef DARWIN
#define DBIO_DEFAULT_SPEC "/Users/nrts"
#else
#define DBIO_DEFAULT_SPEC "/usr/nrts"
#endif
 ...
 *
 * $Log: dbio.h,v $
 * Revision 1.4  2016/07/20 22:55:59  dechavez
 * introduce OS specific DBIO_DEFAULT_SPEC
 *
