#pragma ident "$Id: oldttyio.h,v 1.3 2015/12/04 23:43:45 dechavez Exp $"
/*======================================================================
 *
...
#if defined(BSDOS) || defined(SCO_SV) || defined (LINUX) || defined (BSD) || defined (DARWIN)
#include <termios.h>
#include <strings.h>
#else
 ...
 *
 * $Log: oldttyio.h,v $
 * Revision 1.3  2015/12/04 23:43:45  dechavez
 * added DARWIN to the list of modern unices
 *
