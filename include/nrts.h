#pragma ident "$Id: nrts.h,v 1.27 2016/07/20 21:48:50 dechavez Exp $"
/*======================================================================
 *
...
#ifdef DARWIN
#define NRTS_DEFHOME  "/Users/nrts"
#else
...
struct nrts_timetag {
    ...
    INT16 qual;     /* device independent external clock quality code */
};
...
/* stawd.c */
int nrts_stawd(char *home, char *sta, struct cssio_wfdisc **output, int flush, int maxdur, char *dbspec);
 ...
 *
 * $Log: nrts.h,v $
 * Revision 1.27  2016/07/20 21:48:50  dechavez
 * Changed NRTS_DEFHOME to /Users/nrts for MacOS builds
 *
 * Revision 1.26  2012/02/14 19:48:18  dechavez
 * use portable integer types (eg, long to INT32, unsigned long to UINT32)
 *
 * Revision 1.25  2011/03/17 17:26:41  dechavez
