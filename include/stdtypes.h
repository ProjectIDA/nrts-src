#pragma ident "$Id: stdtypes.h,v 1.14 2012/08/02 17:46:47 dechavez Exp $"
/*======================================================================
 *
 * Portable data types
 *
 ...
 *
 * $Log: stdtypes.h,v $
 * Revision 1.14  2012/08/02 17:46:47  dechavez
 * defined uint32_t for Windows, if not already there (aap)
 *
 * Revision 1.13  2012/02/14 19:45:57  dechavez
 * replaced X86_UNIX and X86_SPARC with more reasonable "unix"
 *
 * Revision 1.12  2010/05/10 16:15:58  dechavez
 * make VOID a define instead of typedef... was confusing the FreeBSD builds of some apps
 *
