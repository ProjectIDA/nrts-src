#pragma ident "$Id: limits.h,v 1.2 2013/05/11 22:36:34 dechavez Exp $"
/*======================================================================
 *
 *  IDA limits
...
#define IDA_NNAMLEN       3  /* Max network name length (inc. NULL) */
 ...
 *
 * $Log: limits.h,v $
 * Revision 1.2  2013/05/11 22:36:34  dechavez
 * added IDA_NNAMLEN
 *
