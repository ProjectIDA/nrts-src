#pragma ident "$Id: setup.c,v 1.2 2014/04/22 22:02:24 dechavez Exp $"
/*======================================================================
 *
...
/* Our working directory will be NRTS_HOME/system/isp */
    ...
    if (getcwd(buffer, MAXPATHLEN+16) == 0) {
        fprintf(stderr, "%s: ", fid);
        perror("getcwd");
        return (char *) NULL;
    }
 ...
 *
 * $Log: setup.c,v $
 * Revision 1.2  2014/04/22 22:02:24  dechavez
 * replaced getwd() with getcwd()
 *
