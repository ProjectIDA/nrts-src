#pragma ident "$Id: wbh.c,v 1.4 2012/02/14 21:45:40 dechavez Exp $"
/*======================================================================
 *
...
/*  Write the header  */
    ...
    fwrite(&hdr->nzyear,    sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->nzjday,    sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->nzhour,    sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->nzmin,     sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->nzsec,     sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->nzmsec,    sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->internal4, sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->internal5, sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->internal6, sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->npts,      sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->internal7, sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->internal8, sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->unused13,  sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->unused14,  sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->unused15,  sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->iftype,    sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->idep,      sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->iztype,    sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->unused16,  sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->iinst,     sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->istreg,    sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->ievreg,    sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->ievtyp,    sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->iqual,     sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->isynth,    sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->unused17,  sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->unused18,  sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->unused19,  sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->unused20,  sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->unused21,  sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->unused22,  sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->unused23,  sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->unused24,  sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->unused25,  sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->unused26,  sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->leven,     sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->lpspol,    sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->lovrok,    sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->lcalda,    sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
    fwrite(&hdr->unused27,  sizeof(INT32),  1, fp);  if (ferror(fp)) return -1;
 ...
 *
 * $Log: wbh.c,v $
 * Revision 1.4  2012/02/14 21:45:40  dechavez
 * use portable integer types (eg, long to INT32, unsigned long to UINT32)
 *
 * Revision 1.3  2009/06/19 18:30:31  dechavez
 * include <string.h> to call FreeBSD compiler
 *
