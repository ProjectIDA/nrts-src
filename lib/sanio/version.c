#pragma ident "$Id: version.c,v 1.10 2015/12/04 22:55:46 dechavez Exp $"
/*======================================================================
 * 
...
static VERSION version = {1, 2, 5};

/* sanio library release notes

1.2.5  12/05/2015
       string.c: fixed = instead of == bug in sanioMessageTypeToString()
