#pragma ident "$Id: crc.c,v 1.1 2009/10/02 19:45:55 dechavez Exp $"
/*======================================================================
 * 
 * MYXML CRC (copy of QDP version, sort of... see byte swap comments)
 *
 *====================================================================*/
#include "myxml.h"

#define MYXML_CRC_TABLE_LEN 256

#ifdef BIG_ENDIAN_HOST
static UINT32 MYXML_CRC_TABLE[MYXML_CRC_TABLE_LEN] = {
...
#endif /* !BIG_ENDIAN_HOST */
        crc.l = crc.l ^ MYXML_CRC_TABLE[temp];
    }

/* The CRC needs to be in big-endian order so that Willard recognizes it! */
