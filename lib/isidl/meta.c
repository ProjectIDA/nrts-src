#pragma ident "$Id: meta.c,v 1.2 2015/12/04 22:14:27 dechavez Exp $"
/*======================================================================
 *
...
/* Build output path name $meta/serialno/currentsequencenumber */
    ...
    sprintf(path+strlen(path), "%c%08x%016llx", PATH_DELIMITER, seqno.signature, seqno.counter);
 ...
 *
 * $Log: meta.c,v $
 * Revision 1.2  2015/12/04 22:14:27  dechavez
