#pragma ident "$Id: master.c,v 1.6 2014/08/28 21:27:36 dechavez Exp $"
/*======================================================================
 *
...
static char *fid = "isidlOpenDiskLoopSet";
    ...
    for (i=0; i < (int) sitelist->count; i++) {
        ...
        if ((dl = isidlOpenDiskLoop(master->glob, site, lp, perm, options)) == NULL) {
 ...
 *
 * $Log: master.c,v $
 * Revision 1.6  2014/08/28 21:27:36  dechavez
