#pragma ident "$Id: print.c,v 1.11 2015/12/04 22:14:27 dechavez Exp $"
/*======================================================================
 *
 * Print/log stuff
 *
...
char buf[BUFLEN];
    ...
    logioMsg(dl->lp, level, "hdrlen = %lu", sys.hdrlen);
...
char buf[BUFLEN];
    ...
    fprintf(fp, " build = %s\n", utilLttostr(sys.seqno.signature, 0, buf));
 ...
 *
 * $Log: print.c,v $
 * Revision 1.11  2015/12/04 22:14:27  dechavez
 * fixed format strings to calm OS X compiles
 *
 * Revision 1.10  2010/11/04 21:47:30  dechavez
 * ISI_DL_SYS hdrlen support
 *
 * Revision 1.9  2010/01/25 17:20:43  dechavez
 * added build time (seqno signature) to isidlPrintDL()
 *
