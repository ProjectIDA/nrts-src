#pragma ident "$Id: unix.c,v 1.5 2015/12/04 22:46:31 dechavez Exp $"
/*======================================================================
 *
 ...
 *
 * $Log: unix.c,v $
 * Revision 1.5  2015/12/04 22:46:31  dechavez
 * fixed signed vs unsigned bug with EncodeBaud() return value and subsequent tests
 *
