#pragma ident "$Id: print.c,v 1.2 2015/12/04 23:05:17 dechavez Exp $"
/*======================================================================
 * 
...
void qdplusPrintPkt(FILE *fp, QDPLUS_PKT *pkt, UINT16 print)
{
    ...
    fprintf(fp, " %08x%016llx ", pkt->seqno.signature, pkt->seqno.counter);
 ...
 *
 * $Log: print.c,v $
 * Revision 1.2  2015/12/04 23:05:17  dechavez
