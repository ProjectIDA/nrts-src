#pragma ident "$Id: state.c,v 1.6 2015/12/04 23:05:17 dechavez Exp $"
/*======================================================================
 *
...
QDPLUS_STATE *state;
    ...
    while (crnt != NULL) {
        ...
        fprintf(fp, " %08x%016llx", state->seqno.signature, state->seqno.counter);
        fprintf(fp, " %d", state->offset);
        fprintf(fp, "\n");
 ...
 *
 * Revision 1.5  2012/08/07 17:38:53  dechavez
 * fixed incorrect argument sanity check in PrintState()
 *
