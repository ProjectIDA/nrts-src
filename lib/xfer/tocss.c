#pragma ident "$Id: tocss.c,v 1.5 2011/03/17 17:57:02 dechavez Exp $"
/*======================================================================
 * 
...
static struct cssio_wfdisc *load_wfdisc(packet)
struct xfer_packet *packet;
{
static struct cssio_wfdisc wfdisc;
 ...
 *
 * $Log: tocss.c,v $
 * Revision 1.5  2011/03/17 17:57:02  dechavez
 * fixed some overlooked wfdisc_null occurences, changing them to cssio_wfdisc_null
 *
 * Revision 1.4  2011/03/17 17:35:13  dechavez
