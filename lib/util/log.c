#pragma ident "$Id: log.c,v 1.19 2015/11/13 21:14:32 dechavez Exp $"
/*======================================================================
 *
 ...
 *
 * $Log: log.c,v $
 * Revision 1.19  2015/11/13 21:14:32  dechavez
 * added explicit format string to syslog() to calm Darwin compiles
 *
