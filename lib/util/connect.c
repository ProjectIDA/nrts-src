#pragma ident "$Id: connect.c,v 1.8 2015/11/13 21:20:13 dechavez Exp $"
/*======================================================================
 *
 ...
 *
 * $Log: connect.c,v $
 * Revision 1.8  2015/11/13 21:20:13  dechavez
 * declare addrlen as unsigned int instead of int
 *
