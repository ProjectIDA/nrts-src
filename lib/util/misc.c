#pragma ident "$Id: misc.c,v 1.17 2015/12/07 18:43:33 dechavez Exp $"
/*======================================================================
 *
 ...
 *
 * $Log: misc.c,v $
 * Revision 1.17  2015/12/07 18:43:33  dechavez
 * removed buggy LinuxSetHostAddr() in favor of working UnixSetHostAddr().  Ie, removed ifdef LINUX test.
 *
