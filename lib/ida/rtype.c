#pragma ident "$Id: rtype.c,v 1.5 2015/11/14 00:50:51 dechavez Exp $"
/*======================================================================
 *
...
int ida_rtype(UINT8 *buf, int rev)
{
    ...
    } else if (strncmp((char *) buf, "tapedmp", strlen("tapedmp")) == 0) {
        return IDA_DMPREC;
    } else if (strncmp((char *) buf, "cartdmp", strlen("cartdmp")) == 0) {
        return IDA_DMPREC;
    } else if (strncmp((char *) buf, "Soviet", strlen("Soviet")) == 0) {
        return IDA_LABEL;
    } else if (strncmp((char *) buf,"IRIS/IDA OME",strlen("IRIS/IDA OME"))==0) {
        return IDA_LABEL;
    } else if (strncmp((char *) buf, "*** END", strlen("*** END")) == 0) {
        return IDA_ARCEOF;
    }
 ...
 *
 * $Log: rtype.c,v $
 * Revision 1.5  2015/11/14 00:50:51  dechavez
