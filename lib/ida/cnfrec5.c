#pragma ident "$Id: cnfrec5.c,v 1.3 2015/11/14 00:50:51 dechavez Exp $"
/*======================================================================
 *
...
/*  Event detector parameters  */
    ...
    ltemp = ((INT32) stemp * 10000L) / 32768L;
    dest->detect.thresh = (INT16) ltemp;
 ...
 *
 * $Log: cnfrec5.c,v $
 * Revision 1.3  2015/11/14 00:50:51  dechavez
