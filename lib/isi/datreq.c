#pragma ident "$Id: datreq.c,v 1.30 2015/12/04 22:01:56 dechavez Exp $"
/*======================================================================
 *
...
static char *fid = "isiSendDataRequest:ReceiveDataRequestAcknowledgment";
    ...
    iacpResetIncoming(&isi->incoming);
 ...
 *
 * $Log: datreq.c,v $
 * Revision 1.30  2015/12/04 22:01:56  dechavez
 * explict cast of arguments and format strings to calm OS X compiles
 *
 * Revision 1.29  2012/06/27 15:23:35  dechavez
 * isiResetIncoming() replaced with iacpResetIncoming()
 *
