#pragma ident "$Id: open.c,v 1.7 2012/06/27 15:23:00 dechavez Exp $"
/*======================================================================
 *
 ...
 *
 * $Log: open.c,v $
 * Revision 1.7  2012/06/27 15:23:00  dechavez
 * isiInitIncoming() replaced with iacpInitIncoming()
 *
