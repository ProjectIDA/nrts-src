#pragma ident "$Id: fileio.c,v 1.2 2015/12/04 22:01:56 dechavez Exp $"
/*======================================================================
 *
 * Read/Write things
 *
...
BOOL isiFileReadSrate(FILE *fp, ISI_SRATE *srate)
{
    ...
    if (!utilReadINT16(fp, &srate->factor)) return FALSE;
    if (!utilReadINT16(fp, &srate->multiplier)) return FALSE;
 ...
 *
 * $Log: fileio.c,v $
 * Revision 1.2  2015/12/04 22:01:56  dechavez
