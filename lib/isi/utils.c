#pragma ident "$Id: utils.c,v 1.23 2014/08/28 21:30:54 dechavez Exp $"
/*======================================================================
 *
...
/* Given an ISI_STREAM_NAME with chnloc, populate the chn and loc fields */
...
LISS_PKT pkt;
    ...
    strlcpy(name->sta, pkt.hdr.fsdh.staid, ISI_STALEN+1); util_lcase(name->sta);
    strlcpy(name->chn, pkt.hdr.fsdh.chnid, ISI_CHNLEN+1); util_lcase(name->chn);
    strlcpy(name->loc, pkt.hdr.fsdh.locid, ISI_LOCLEN+1); util_lcase(name->loc);
 ...
 *
 * $Log: utils.c,v $
 * Revision 1.23  2014/08/28 21:30:54  dechavez
 * removed isiAllocMseedExtras()
 *
 * Revision 1.22  2013/01/14 22:05:24  dechavez
 * added isiChnlocToChnLoc()
 *
 * Revision 1.21  2012/06/27 15:20:57  dechavez
 * fixed isiAllocMseedExtras() bug when splitting long station names into 4+2 sta/net
 *
 * Revision 1.20  2011/11/09 22:52:19  dechavez
 * pad short names with spaces in FSDH
 *
 * Revision 1.19  2011/11/09 20:08:15  dechavez
 * split illegal (too long) station names into sta+net
 *
 * Revision 1.18  2011/11/07 17:33:44  dechavez
 * removed INCLUDE_MSEED conditionals
 *
 * Revision 1.17  2011/11/03 17:33:44  dechavez
 * added isiAllocMseedExtras() and conditional (INCLUDE_MSEED) support for ISI_TYPE_MSEED
 *
