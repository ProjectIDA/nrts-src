#pragma ident "$Id: soh.c,v 1.9 2015/12/04 22:01:56 dechavez Exp $"
/*======================================================================
 *
...
char tmpbuf[256];
    ...
    sprintf(buf+strlen(buf), " %5u", soh->nseg);
    sprintf(buf+strlen(buf), " %8u", soh->nrec);
 ...
 *
 * $Log: soh.c,v $
 * Revision 1.9  2015/12/04 22:01:56  dechavez
