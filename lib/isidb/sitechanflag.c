#pragma ident "$Id: sitechanflag.c,v 1.5 2015/12/04 22:09:13 dechavez Exp $"
/*======================================================================
 *
 ...
 * Revision 1.5  2015/12/04 22:09:13  dechavez
 * fixed FALSE instead of NULL return value bug (benign)
 *
