#pragma ident "$Id: oldbwd.c,v 1.4 2014/03/12 16:47:33 dechavez Exp $"
/*======================================================================
 *
...
/*  Write out the information  */
    ...
    len  = sizeof(struct cssio_wfdisc);
...
static char *fid = "nrts_bwd";
    ...
    /* Create a new wfdisc record and append to the end of the list */
      ...
      case NRTS_TESTWD:
        ...
        diff     = (float) ((INT32) (1000.0*(hd->wfdisc.time - expected))/1000);
 ...
 *
 * $Log: oldbwd.c,v $
 * Revision 1.4  2014/03/12 16:47:33  dechavez
 * renamed flag variable to action, to avoid conflict with include/dmc/libmseed.h flag type
 *
 * Revision 1.3  2012/02/14 20:19:04  dechavez
 * use portable integer types (eg, long to INT32, unsigned long to UINT32)
 *
 * Revision 1.2  2011/03/17 17:34:19  dechavez
