#pragma ident "$Id: ida10.c,v 1.6 2015/12/04 23:15:12 dechavez Exp $"
/*======================================================================
 *
 *  QDP_HLP to IDA10.4
 *
...
/* 10.4 TS header */
    ...
    *ptr++ = hlp->src[1];
    ...
    ptr += utilPackBytes(ptr, (UINT8 *) chnloc, 6);
 ...
 *
 * Revision 1.5  2010/03/12 00:28:54  dechavez
 * added LCQ src bytes to IDA10.4 header
 *
