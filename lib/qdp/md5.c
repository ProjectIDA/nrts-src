#pragma ident "$Id: md5.c,v 1.8 2015/12/04 23:15:12 dechavez Exp $"
/*======================================================================
 * 
...
char string[80 + 1];
    ...
    ptr = string;
    snprintf(string, 81, "%016llx%08x%04x%04x%016llx%016llx%016llx",
        c1_srvrsp->challenge,
        c1_srvrsp->dp.ip,
        c1_srvrsp->dp.port,
 ...
 *
 * $Log: md5.c,v $
 * Revision 1.8  2015/12/04 23:15:12  dechavez
