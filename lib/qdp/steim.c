#pragma ident "$Id: steim.c,v 1.8 2016/01/23 00:19:35 dechavez Exp $"
/*======================================================================
 *
...
{
typedef struct { INT32 ndif; INT32 nbit; } DECODE_VALUES;
...
INT8 *ptr;
    ...
    /* 01 = same as Steim1, four 1-byte (8-bit) differences contained in sequence */
      ...
      case B01:
        ...
        utilSwapUINT32(&sequence, 1);
#endif
        for (ptr = (INT8 *) &sequence, i = 0; i < 4; i++) {
...
/* Decompress the data in one compressed environmental processor special blocketete */
 ...
 *
 * $Log: steim.c,v $
 * Revision 1.8  2016/01/23 00:19:35  dechavez
 * added qdpDecompressENVDAT()
 *
 * Revision 1.7  2015/12/04 23:15:12  dechavez
 * casts, format fixes and the like, all to calm OS X compiles
 *
 * Revision 1.6  2009/06/19 18:08:27  dechavez
 * fixed nasty B01 little-endian byte order bug,
