#pragma ident "$Id: stats.c,v 1.10 2015/12/04 23:15:12 dechavez Exp $"
/*======================================================================
 * 
...
static void InitCounter(QDP_COUNTER *counter)
{
    counter->overrun = 0;
    counter->crc = 0;
    counter->data = 0;
 ...
 *
 * $Log: stats.c,v $
 * Revision 1.10  2015/12/04 23:15:12  dechavez
 * casts, format fixes and the like, all to calm OS X compiles
 *
 * Revision 1.9  2015/12/03 18:05:13  dechavez
 * made InitCounter() static
 *
