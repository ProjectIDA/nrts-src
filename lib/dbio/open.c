#pragma ident "$Id: open.c,v 1.7 2016/07/20 23:09:02 dechavez Exp $"
/*======================================================================
 *
...
{
DBIO *db;
static char *default_spec = DBIO_DEFAULT_SPEC;
static char *fid = "dbioOpen";

    if (spec == NULL && (spec = getenv(DBIO_ENV_STRING)) == NULL) spec = default_spec;
 ...
 *
 * $Log: open.c,v $
 * Revision 1.7  2016/07/20 23:09:02  dechavez
 * dbioOpen() to default to DBIO_DEFAULT_SPEC if not otherwise specified
 *
