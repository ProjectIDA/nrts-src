#pragma ident "$Id: handshake.c,v 1.8 2015/11/14 00:39:35 dechavez Exp $"
/*======================================================================
 * 
 * IACP handshake
 *
...
/* Update peer ident */
    ...
    sprintf(iacp->peer.ident, "pid%u@%s", iacp->peer.pid, iacp->peer.name);
 ...
 *
 * $Log: handshake.c,v $
 * Revision 1.8  2015/11/14 00:39:35  dechavez
