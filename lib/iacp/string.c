#pragma ident "$Id: string.c,v 1.2 2015/11/14 00:39:55 dechavez Exp $"
/*======================================================================
 * 
...
int i;
    ...
    sprintf(UnknownError, "alert code %u", code); /* not MT safe, but should never occur */
    return UnknownError; 
}
 ...
 *
 * $Log: string.c,v $
 * Revision 1.2  2015/11/14 00:39:55  dechavez
 * changed sprintf format string to calm Darwin compiles
 *
