#pragma ident "$Id: loginfo.c,v 1.3 2015/12/04 23:44:16 dechavez Exp $"
/*======================================================================
 *
...
#if defined(bsdi) || defined (BSD) || defined (DARWIN)
#define NIFLAG 13
...
/*  Input modes  */
    ...
    if (tty->c_iflag != 0) {
        ...
        sprintf(string, "c_iflag     = 0x%04lx", tty->c_iflag);
    }
    for (i = 0; i < NIFLAG; i++) {
...
/*  Output modes  */
    ...
    if (tty->c_oflag != 0) {
        ...
        sprintf(string, "c_oflag     = 0x%04lx", tty->c_oflag);
    }
#ifdef SUNOS
...
/*  Control modes  */
    ...
    if (tty->c_cflag != 0) {
        ...
        sprintf(string, "c_cflag     = 0x%04lx", tty->c_cflag);
    }
...
/*  Local modes  */
    ...
    if (tty->c_lflag != 0) {
        ...
        sprintf(string, "c_lflag     = 0x%04lx", tty->c_lflag);
    }
    for (i = 0; i < NLFLAG; i++) {
 ...
 *
 * $Log: loginfo.c,v $
 * Revision 1.3  2015/12/04 23:44:16  dechavez
