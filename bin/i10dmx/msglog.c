#pragma ident "$Id: msglog.c,v 1.6 2015/12/07 19:55:33 dechavez Exp $"
/*======================================================================
 *
 *  Message logger.
 *
...
void close_msglog()
{
INT32 rps_wall, total_wall;
INT32 wall_hr, wall_mn, wall_sc;

#ifdef unix
int  percent;
struct tms elapsed;
INT32 rps_cpu, total_cpu;
#endif
    ...
    fprintf(fp, "Elapsed CPU  time = %d seconds (%ldu + %lds)\n", total_cpu, elapsed.tms_utime, elapsed.tms_stime);
...
#ifdef unix
    fprintf(fp,"cpu rate = %d, ", rps_cpu);
#endif
    fprintf(fp,"wall rate = %d rec/sec\n", rps_wall);
 ...
 *
 * $Log: msglog.c,v $
 * Revision 1.6  2015/12/07 19:55:33  dechavez
