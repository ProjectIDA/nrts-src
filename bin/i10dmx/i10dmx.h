#pragma ident "$Id: i10dmx.h,v 1.17 2015/12/07 19:55:33 dechavez Exp $"
/*======================================================================
 *
...
void InitDetector(Q330_DETECTOR *engine);
...
void unpackII(UINT8 *buf, UINT32 recno);
 ...
 *
 * $Log: i10dmx.h,v $
 * Revision 1.17  2015/12/07 19:55:33  dechavez
 * all sorts of changes to calm OS X builds
 *
 * Revision 1.16  2013/12/12 19:04:09  dechavez
 * added maxsec argument to init_wfdisc prototype
 *
 * Revision 1.15  2011/03/17 20:47:41  dechavez
 * use the new CSSIO_, cssio_, prefixed names from libcssio 2.2.0
 *
 * Revision 1.14  2011/02/24 17:23:26  dechavez
 * use gzFile instead of FILE for I/O
 *
 * Revision 1.13  2010/12/17 19:49:39  dechavez
 * 2.4.1
 *
