#pragma ident "$Id: paro.c,v 1.7 2015/12/22 23:13:18 dechavez Exp $"
/*======================================================================
 *
...
char byte, *reply;
    ...
    if (raw) {
        do {
            if (ttyioRead(pp->tty, (UINT8 *) &byte, 1) == 1) {
...
/*  Connect to the device  */
    ...
    printf("Connecting to device at `%s', speed %ld\n", port, baud);
 ...
 *
 * $Log: paro.c,v $
 * Revision 1.7  2015/12/22 23:13:18  dechavez
 * changed default FreeBSD port to /dev/cuau0
 *
 * Revision 1.6  2015/12/07 19:12:01  dechavez
 * changes needed to get clean Mac OS X build
 *
