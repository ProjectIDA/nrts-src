#pragma ident "$Id: main.c,v 1.2 2015/12/08 21:34:04 dechavez Exp $"
/*======================================================================
 *
...
UINT64 keep;
    ...
    fprintf(stderr, "%u packets in\n", in);
    fprintf(stderr, "%u packets out\n", out);
}

/* Revision History
 *
 * $Log: main.c,v $
 * Revision 1.2  2015/12/08 21:34:04  dechavez
