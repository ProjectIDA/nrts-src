#pragma ident "$Id: etoh.c,v 1.7 2014/04/18 21:23:48 dechavez Exp $"
/*======================================================================
 *
...
char *myname;
{
    ...
    fprintf(stderr, "10    Day Mon hh:mm:ss year\n");
    fprintf(stderr, "14    dd mnth yyyy (ddd)\n");
    fprintf(stderr, "15    hh:mm:ss\n");
    fprintf(stderr, "16    yyyyddd Mon dd, yyyy hh:mm:ss\n");
    fprintf(stderr, "\n");
 ...
 *
 * $Log: etoh.c,v $
 * Revision 1.7  2014/04/18 21:23:48  dechavez
 * added support for format codes 10, 14, 15, 16
 *
