#pragma ident "$Id: twind.c,v 1.14 2015/12/08 18:39:06 dechavez Exp $"
/*======================================================================
 *
 ...
 *
 * $Log: twind.c,v $
 * Revision 1.14  2015/12/08 18:39:06  dechavez
 * fixed a nasty = instead of == bug when testing errno.  Thanks to Apple clang
 * for finally catching this!
 *
