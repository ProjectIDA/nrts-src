#pragma ident "$Id: isid.h,v 1.29 2015/12/08 18:43:38 dechavez Exp $"
...
#define ISID_MOD_GENERIC  ((INT32) 1500)
#define ISID_MOD_ECHO     ((INT32) 1600)
...
typedef struct {
    ...
    IACP_MULTI_MSG incoming;   /* for tracking incoming multi-part messages */
 ...
 *
 * $Log: isid.h,v $
 * Revision 1.29  2015/12/08 18:43:38  dechavez
 * included echo.c protypes
 *
 * Revision 1.28  2012/06/27 15:33:33  dechavez
 * replaced ISI_INCOMING with IACP_MULTI_MSG (still the same structure)
 *
 * Revision 1.27  2012/05/30 21:15:27  dechavez
 * added echo service support
 *
 * Revision 1.26  2010/08/27 18:56:37  dechavez
 * support for generic reports (ISI_IACP_REQ_REPORT)
 *
