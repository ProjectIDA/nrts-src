...
4.4.2  03/12/2014
       Fixed byte order bug probably introduced in January when linked with libnrts 4.16.0
...
4.3.3  01/18/2013
       link with libnrts 4.15.0 (hopefully no side effects :-)

4.3.2  12/20/2012
       Fix byte order problem when serving generic REAL32/REAL64 data from little-endian servers

4.3.1  06/27/2012
       Changes related with the with libiacp 1.10.0 and libisi 2.15.0
       ISI_INCOMING -> IACP_MULTI_MSG change

4.3.0  05/30/2012
       -echo option to make an echo server

4.2.6  11/07/2011
       Using libisi 2.14.0 isiRawToMiniSeed instead of localo version
...
3.6.0  08/27/2010
       Support for generic reports (ISI_IACP_REQ_REPORT) introduced.
       Only request for DL_SYS reports recognized at present.

3.5.1  01/29/2009
       Set resource limit for number of open files to maximum allowed by the system
