#pragma ident "$Id: status.c,v 1.4 2015/12/08 18:40:00 dechavez Exp $"
/*======================================================================
 *
 *  Status reports
 *
 ...
 *
 * $Log: status.c,v $
 * Revision 1.4  2015/12/08 18:40:00  dechavez
 * fixed a type clash in clen to calm DARWIN builds
 *
