#pragma ident "$Id: fixvar.c,v 1.5 2014/08/11 19:16:44 dechavez Exp $"
/*======================================================================
 *
...
{
    printf("usage: %s\n", name);
    printf("Prints fixed values after reboot report (C1_FIX)\n");
}
 ...
 *
 * $Log: fixvar.c,v $
 * Revision 1.5  2014/08/11 19:16:44  dechavez
 * changed name of FixvarHelp() to FixHelp()
 *
 * Revision 1.4  2009/07/23 20:31:03  dechavez
