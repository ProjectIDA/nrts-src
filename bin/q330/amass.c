#pragma ident "$Id: amass.c,v 1.3 2009/07/23 20:31:03 dechavez Exp $"
/*======================================================================
 *
...
{
    printf("usage: %s\n", name);
    printf("Reports sensor A and B automatic mass recentering configuration.\n");
}
