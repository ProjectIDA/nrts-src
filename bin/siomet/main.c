#pragma ident "$Id: main.c,v 1.2 2017/09/29 16:14:40 dechavez Exp $"
/*======================================================================
 *
...
static void help(char *myname)
{
    ...
    fprintf(stderr,"server => name or IP address of ISI disk loop server\n");
    fprintf(stderr,"port   => port number for ISI disk loop server\n");
    fprintf(stderr,"\n");
 ...
 *
 * $Log: main.c,v $
 * Revision 1.2  2017/09/29 16:14:40  dechavez
 * added server and port explanations to help message
 *
