#pragma ident "$Id: signals.c,v 1.1 2017/09/28 18:20:44 dauerbach Exp $"
/*======================================================================
 *
...
#define MY_MOD_ID SIOMET_MOD_SIGNALS
...
static char *fid = "SignalHandlerThread";
    ...
    while (1) {
        ...
        switch (sig) {
          ...
          case SIGUSR1:
            LogMsg("SIGHUP");
            ToggleReadThreadVerbosity();
            break;

          case SIGHUP:
            LogMsg("SIGHUP");
            ToggleProcessThreadVerbosity();
            break;
