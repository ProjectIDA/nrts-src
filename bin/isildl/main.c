#pragma ident "$Id: main.c,v 1.9 2015/12/08 17:44:26 dechavez Exp $"
/*======================================================================
 *
...
ISI_DL_MASTER *master;
    ...
    if ((master = isidlOpenDiskLoopSet(list, &glob, NULL, ISI_RDONLY, ISI_OPTION_NONE)) == NULL) {
 ...
 *
 * $Log: main.c,v $
 * Revision 1.9  2015/12/08 17:44:26  dechavez
 * include nrts/dl.h to bring in needed prototypes
 *
 * Revision 1.8  2014/08/28 21:47:56  dechavez
