#pragma ident "$Id: signals.c,v 1.3 2014/08/28 23:13:22 dechavez Exp $"
/*======================================================================
 *
...
#define MY_MOD_ID PARO10_MOD_SIGNALS
 ...
 *
 * $Log: signals.c,v $
 * Revision 1.3  2014/08/28 23:13:22  dechavez
 * log barometer serial number on SIGUSR2
 *
