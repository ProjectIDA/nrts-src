#pragma ident "$Id: exitcode.c,v 1.3 2014/04/22 22:00:17 dechavez Exp $"
/*======================================================================
 *
 *  Exit handlers.
 *
...
char pwd[MAXPATHLEN+1];
    ...
    switch (sig) {
      ...
      default:
        util_log(1, "abort on unexpected %s", util_sigtoa(sig));
        abort();
 ...
 *
 * $Log: exitcode.c,v $
 * Revision 1.3  2014/04/22 22:00:17  dechavez
 * removed call to now deprecated getwd()
 *
