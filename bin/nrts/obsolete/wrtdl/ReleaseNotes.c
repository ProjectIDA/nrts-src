#pragma ident "$Id: ReleaseNotes.c,v 1.31 2012/02/14 19:45:17 dechavez Exp $"

char *VersionIdentString = "Release 3.1.1";

/* Release Notes

3.1.1   02/15/2012
        changed getrec.c to use portable interger types to avoid warning from src/include/seed.h Revision 1.5
