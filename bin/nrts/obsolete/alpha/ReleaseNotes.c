#pragma ident "$Id: ReleaseNotes.c,v 1.2 2010/04/21 16:27:18 dechavez Exp $"

char *VersionIdentString = "Release 3.1.2";

/* Release Notes

3.1.2  04/21/2010
       fixed it so it really does map 12 to NE

3.1.1  04/19/2010
       map 12 channels to NE
