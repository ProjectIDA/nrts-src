#pragma ident "$Id: nrts_mon.h,v 1.6 2015/12/09 18:38:52 dechavez Exp $"
...
void getmaxnchn(char *home, int *nchn);
...
void chlog(char *log);
void chsystem(char *sysname, char *home);
int mkscreen();
void chpid();
void log_win();
 ...
 *
 * $Log: nrts_mon.h,v $
 * Revision 1.6  2015/12/09 18:38:52  dechavez
 * fixed up prototypes
 *
