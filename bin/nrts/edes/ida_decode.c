#pragma ident "$Id: ida_decode.c,v 1.8 2015/12/09 18:36:06 dechavez Exp $"
/*======================================================================
 *
...
static char *fid = "ida_decode";
    ...
    crnt = &dhead;
    if (ida_dhead(ida, crnt, (UINT8 *) buffer) != 0) {
    ...
    packet.hdr  = (UINT8 *) buffer;
    packet.dat  = (UINT8 *) buffer + packet.hlen;
    packet.data = (INT32 *) (buffer + packet.hlen);
 ...
 *
 * $Log: ida_decode.c,v $
 * Revision 1.8  2015/12/09 18:36:06  dechavez
 * various minor tweaks to get clean Mac OS X builds
 *
 * Revision 1.7  2012/02/14 21:33:09  dechavez
