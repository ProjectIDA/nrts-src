#pragma ident "$Id: ReleaseNotes.c,v 1.30 2015/08/24 19:18:02 dechavez Exp $"

char *VersionIdentString = "Release 3.5.1";

/* Release Notes

3.5.1   08/24/2015
        log connections at log level 1 (instead of 2)
